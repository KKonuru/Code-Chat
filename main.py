...
class codeChat():
    def __init__(self,path:str):
        ...
        self._path = path
        self._vectorstore = self.create_vector_store()
    ...
    def query_translation(self,query:str)->str:
        template = """
    ...
    def embedding_function(self,code)->np.ndarray:
